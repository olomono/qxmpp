...
void tst_QXmppPubSubManager::testHandleStanza_data()
{
    ...
    expectedIq.setQueryNode("princely_musings");
...
void tst_QXmppPubSubManager::testHandleStanza()
{
    ...
    connect(m_manager, &QXmppPubSubManager::itemsReceived, &context, [&](const QXmppPubSubIq &iq) {
        ...
        QCOMPARE(iq.queryNode(), expectedIq.queryNode());
...
void tst_QXmppPubSubManager::testMessageReceived_data()
{
    ...
    parsePacket(
        ...
        QString("<message from='pubsub.shakespeare.lit' to='francisco@denmark.lit' id='foo'>"
    ...
    parsePacket(
        ...
        QString("<message from='romeo@example.net/orchard' id='sl3nx51f' to='juliet@example.com/balcony'>"
