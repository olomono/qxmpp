...
///
void QXmppOmemoDevice::setId(const int id)
{
    if (id > 0) {
        d->id = id;
    }
...
///
/// Returns the trust level of this device's key.
///
/// The possible trust levels are determined by the implementer.
...
///
/// Sets the trust level of this device's key.
///
/// \see trustLevel
///
...
///
/// The possible device statuses are determined by the implementer.
/// This library makes no assumptions about the stored value.
///
