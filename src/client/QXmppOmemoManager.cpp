...
///
void QXmppOmemoManager::changePassword(const QString &newPassword)
{
...
///
void QXmppOmemoManager::deleteAccount()
{
...
bool QXmppOmemoManager::supportedByServer() const
{
...
///
void QXmppOmemoManager::requestRegistrationForm(const QString &service)
{
    QXmppRegisterIq iq;
...
///
void QXmppOmemoManager::setRegistrationFormToSend(const QXmppRegisterIq &iq)
{
...
///
void QXmppOmemoManager::setRegistrationFormToSend(const QXmppDataForm &dataForm)
{
...
/// the QXmppOmemoManager.
///
void QXmppOmemoManager::sendCachedRegistrationForm()
{
...
///
bool QXmppOmemoManager::registerOnConnectEnabled() const
{
...
///
void QXmppOmemoManager::setRegisterOnConnectEnabled(bool enabled)
{
...
void QXmppOmemoManager::handleDiscoInfo(const QXmppDiscoveryIq &iq)
{
...
void QXmppOmemoManager::setSupportedByServer(bool registrationSupported)
{
